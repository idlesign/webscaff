# -*- coding: utf-8 -*-
#
# webscaff documentation build configuration file.
#
...
latex_documents = [
  ('index', 'webscaff.tex', u'webscaff Documentation',
...
man_pages = [
    ('index', 'webscaff', u'webscaff Documentation',
