...
class TestProj:
    ...
    def test_bootstrap(self, run_command_mock, monkeypatch):
        ...
        assert run_command_mock('run.initialize') == [
            ...
            'test -e "$(echo ~/mydemo/bootstrap)"',
            'test -e "$(echo ~/mydemo/bootstrap)"',
            'egrep "^paths$" "~/mydemo/bootstrap"',
            'test -e "$(echo /srv/mydemo/.git)"',
            'test -e "$(echo ~/mydemo/bootstrap)"',
            'test -e "$(echo ~/mydemo/bootstrap)"',
            'egrep "^git$" "~/mydemo/bootstrap"',
            'test -e "$(echo ~/mydemo/bootstrap)"',
            'test -e "$(echo ~/mydemo/bootstrap)"',
            ...
            'test -e "$(echo ~/mydemo/bootstrap)"',
            'test -e "$(echo ~/mydemo/bootstrap)"',
            'egrep "^uwsgi$" "~/mydemo/bootstrap"',
            'systemctl enable --now /srv/mydemo/conf/mydemo.service',
            'test -e "$(echo ~/mydemo/bootstrap)"',
            'test -e "$(echo ~/mydemo/bootstrap)"',
            'egrep "^service$" "~/mydemo/bootstrap"',
            ...
            'test -e "$(echo ~/mydemo/bootstrap)"',
            'test -e "$(echo ~/mydemo/bootstrap)"',
            'egrep "^certbot$" "~/mydemo/bootstrap"',
            'shutdown -r now'
        ]
